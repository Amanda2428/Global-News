...
<body class="text-gray-700 pt-9 sm:pt-10">
            ...
            <div class="flex flex-row items-center text-gray-300">
              <div class="search-dropdown relative border-r lg:border-l border-gray-800 hover:bg-gray-900">
                <button class="block py-3 px-6 border-b-2 border-transparent">
                  ...
                  <!-- Close Icon  -->
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="close bi bi-x-lg hidden" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M13.854 2.146a.5.5 0 0 1 0 .708l-11 11a.5.5 0 0 1-.708-.708l11-11a.5.5 0 0 1 .708 0Z" />
                    <path fill-rule="evenodd" d="M2.146 2.146a.5.5 0 0 0 0 .708l11 11a.5.5 0 0 0 .708-.708l-11-11a.5.5 0 0 0-.708 0Z" />
                  </svg>
                </button>
                <div class="dropdown-menu hidden absolute left-auto right-0 top-full z-50 text-left bg-white text-gray-700 border border-gray-100 mt-1 p-3" style="min-width: 15rem;">
              ...
              <div class="relative hover:bg-gray-800 block lg:hidden">
                <button type="button" class="menu-mobile block py-3 px-6 border-b-2 border-transparent" onclick="toggleMobileMenu()">
  ...
  <div id="mobileMenu" class="side-area fixed w-full h-full inset-0 z-50 hidden">
    <!-- Background overlay -->
    <div class="back-menu fixed bg-gray-900 bg-opacity-70 w-full h-full inset-x-0 top-0" onclick="toggleMobileMenu()"></div>
    ...
    <nav id="mobile-nav" class="side-menu flex flex-col right-0 w-64 fixed top-0 bg-white dark:bg-gray-800 h-full overflow-auto z-40">
      ...
      <div class="py-4 px-6 text-sm mt-6 text-center">
        <p>Copyright <a href="#">Tailnews</a> - All rights reserved</p>
      </div>
    </nav>
  </div>
  ...
  <script>
    ...
    document.querySelectorAll('.search-dropdown button').forEach(button => {
      button.addEventListener('click', function() {
        ...
        const searchIcon = this.querySelector('.open');
