                        ...
                        <div class="flex flex-row items-center text-gray-300">
                            <div
                                ...
                                <button class="block py-3 px-6 border-b-2 border-transparent">
                                    ...
                                    <!-- Close Icon  -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="close bi bi-x-lg hidden" viewBox="0 0 16 16">
                                ...
                                <div class="dropdown-menu hidden absolute left-auto right-0 top-full z-50 text-left bg-white text-gray-700 border border-gray-100 mt-1 p-3"
