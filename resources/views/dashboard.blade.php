                ...
                <div class="flex relative inline-block float-right">
                    <div class="relative text-sm">
                        ...
                        <div id="userMenu" class="bg-white rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
                            <ul class="list-reset">
                                <li><a href="{{route('profile.edit')}}" class="px-4 py-2 block text-gray-900 hover:bg-gray-400 no-underline hover:no-underline">My account</a></li>
                                <li>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{route('dashboard')}}" class="block py-1 md:py-3 pl-1 align-middle text-pink-600 no-underline hover:text-gray-900 border-b-2 border-orange-600 hover:border-orange-600">
                    ...
                    <li class="mr-6 my-2 md:my-0 relative">
                        ...
                        <div id="adminDropdown" class="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg hidden">
                            <ul class="list-reset w p-2">
                                <li><a href="{{route('admin.goToUserList')}}" class="block py-1 px-2 text-gray-700 hover:bg-gray-200"><i class="fas fa-user mr-2"></i>Users</a></li>
                                <li><a href="{{route('admin.goToAdminList')}}" class="block py-1 px-2 text-gray-700 hover:bg-gray-200"><i class="fas fa-users-cog mr-2"></i>Admins</a></li>
                ...
                <div class="flex w-full md:w-1/2">
                    <div class="px-8">
                        ...
                        <ul class="list-reset items-center text-sm pt-3">
                            <li>
                                <a class="inline-block text-gray-400 no-underline hover:text-gray-50 hover:underline py-1" href="#">Add social link</a>
                            </li>
                            <li>
                                <a class="inline-block text-gray-400 no-underline hover:text-gray-50 hover:underline py-1" href="#">Add social link</a>
                            </li>
